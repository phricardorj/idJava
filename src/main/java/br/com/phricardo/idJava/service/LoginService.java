...
public class LoginService {
    ...
    public ResponseEntity<?> isValid(UserLoginRequestDto userLoginRequestDto) {
        ...
        if(!email.isEmpty() || !username.isEmpty()){
            ...
            return new ResponseEntity<>(new ErrorResponseDto("Username or Email needs to be informed"), HttpStatus.BAD_REQUEST);
        }

        return new ResponseEntity<>(new ErrorResponseDto("Username or Email not found in the system"), HttpStatus.BAD_REQUEST);
    }
